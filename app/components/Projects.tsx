    ...
    <section id="projects" className="py-20">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="relative">
          ...
          <button
            onClick={() => scroll("left")}
            className="absolute left-0 top-1/2 transform -translate-y-1/2 bg-white p-3 rounded-full shadow-lg hover:bg-gray-100 z-10"
          >
            &#8592;
          </button>
          ...
          <div
            ref={scrollRef}
            className="flex overflow-x-auto space-x-6 scroll-smooth px-6 scrollbar-hide"
          >
            {projects.map((project, index) => (
              <div
                key={index}
                className="min-w-[300px] md:min-w-[400px] bg-white rounded-xl border border-gray-300 shadow-md overflow-hidden hover:shadow-2xl hover:scale-[1.03] transform transition-all duration-300 ease-in-out"
              >
                <div className="p-6">
                  {project.thumbnailUrl && (
                    ...
                    >
                      <div className="w-full h-64 overflow-hidden rounded-lg mb-4 shadow-md hover:shadow-lg transition-shadow">
                        <img
